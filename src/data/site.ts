// Central content file for the IEEE ComSoc Rwanda Chapter website.
...
export const site = {
  name: "IEEE ComSoc Rwanda Chapter",
  ...
  email: "comsoc.rwanda@ieee.org", // TODO: confirm official chapter email
  city: "Kigali, Rwanda",
...
export const events: EventItem[] = [
  ...
  {
    title:
      "Twin Chapter Program: Joint Technical Session with IEEE ComSoc Kerala Chapter",
    date: "2026-06-30",
    location: "Online (Google Meet)",
    description:
      "Joint session under ComSoc's Twin Chapter Program. Talks: “The Future of Spectrum Sovereignty” by Dr. Edwin Mugume (CMU-Africa) and “Digital Battlefield: Radar Communication and Sensor Fusion in Contemporary Fighter Aircrafts” by Krishna Priya Boban (IEEE ComSoc Kerala).",
    past: true,
  },
